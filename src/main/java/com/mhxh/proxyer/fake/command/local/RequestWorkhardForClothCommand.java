...
public class RequestWorkhardForClothCommand extends LocalBaseCommand {
    public RequestWorkhardForClothCommand() {
        super(LocalSendCommandRuleConstants.WORK_HARD_FOR_CLOTH_ONE_TIME);
    }
