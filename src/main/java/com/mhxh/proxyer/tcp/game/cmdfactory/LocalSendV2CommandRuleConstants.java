...
public class LocalSendV2CommandRuleConstants {
    ...
    // 请求轮回人劫
    public static final String ROLE_REQUEST_FIGHT_WITH_LUNHUI_GBK_V2 = "1501*-*do local ret={[\"地图\"]=1193,[\"编号\"]=%s,[\"标识\"]=%s,[\"序列\"]=%s} return ret end*-*%s";

    // 干轮回人劫
    public static final String ROLE_FIGHT_WITH_LUNHUI_GBK_V2 = "1502*-*do local ret={[1]=\"那就试试\",[2]=1193,[3]=\"轮回-人劫\"} return ret end*-*%s";
